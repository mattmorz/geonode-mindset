...
if EMAIL_ENABLE:
    ...
    EMAIL_PORT = 587
    EMAIL_HOST_USER = 'jryanmorz@gmail.com'
    EMAIL_HOST_PASSWORD = 'mattmorz'
    EMAIL_USE_TLS = True
    DEFAULT_FROM_EMAIL = 'MinDSET DEPot <no-reply@geonode.org>'
else:
    EMAIL_BACKEND = os.getenv('DJANGO_EMAIL_BACKEND',
...
MANAGERS = ADMINS = os.getenv('ADMINS', ['idsilmat@gmail',])
...
THEME_ACCOUNT_CONTACT_EMAIL = os.getenv(
    'THEME_ACCOUNT_CONTACT_EMAIL', 'idsilmat@gmail.com'
)
...
DISPLAY_WMS_LINKS = strtobool(os.getenv('DISPLAY_WMS_LINKS', 'False'))
